...
<body>
    ...
    <div class="container">
        <div class="header-item">
            <div class="item">
                <a href="../Hangsanxuat/Themhangsanxuat.php">Thêm hãng sản xuất</a>
            </div>
        </div>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <div class="product">
                            ...
                            <a href="../Hangsanxuat/Suahangsanxuat.php?mahangsx=<?php echo $row['Mahangsx']; ?>" class="btn btn-primary">Chỉnh sửa</a>
                            <a href="../Hangsanxuat/Xoahangsanxuat.php?mahangsx=<?php echo $row['Mahangsx']; ?>" class="btn btn-danger">Xóa</a>
                        </div>
                    <?php endwhile; ?>
                <?php else: ?>
